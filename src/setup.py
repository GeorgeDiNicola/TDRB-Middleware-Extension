...
def convert_table_to_column_encryption_record(table, table_name):
	...
	cer.column_hash = SHA_256_conversion(concatentated_primary_keys)  # hash the concatenated primary keys
...
def convert_table_to_row_encryption_records(table, table_name):
	...
	for index, row in table.iterrows():
		...
		rer.item_hash = SHA_256_conversion(concatentated_items)  # hash the items in the row
